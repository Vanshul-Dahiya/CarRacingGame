...
class GameView ( var cntxt : Context, var gameTask: GameTask) : View(cntxt)
{
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        val d = resources.getDrawable(R.drawable.my_car , null)
